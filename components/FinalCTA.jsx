  ...
  return (
    <section ref={sectionRef} className="min-h-screen flex flex-col justify-center items-center px-6 md:px-12 py-20">
      ...
      >
        ...
        >
          <button className="group relative bg-white text-black font-bold text-xl md:text-2xl uppercase tracking-wider px-16 py-6 rounded-full hover:bg-gray-200 transition-all duration-300 overflow-hidden">
